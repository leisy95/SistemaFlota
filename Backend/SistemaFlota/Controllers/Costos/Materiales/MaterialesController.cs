...
namespace SistemaFlota.Controllers.Costos.Materiales
{
    [ApiController]
    ...
    public class MaterialesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<MaterialDto>> Crear([FromBody] CrearMaterialDto dto)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Actualizar(int id, [FromBody] ActualizarMaterialDto dto)
        {
            if (!ModelState.IsValid)
                return ValidationProblem(ModelState);
